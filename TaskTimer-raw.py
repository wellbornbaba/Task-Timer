...
class TaskTimer:    
    ...
    def pop_notify(self, title, msg):
        sub_title = f'TaskTimer:: {title}'
        toaster = ToastNotifier()
        toaster.show_toast(sub_title, msg, icon_path=self.app_Icon, duration=10)
            
        # if title =='Completed':
        #     mb.showinfo(sub_title, msg)
        # elif title =='Error':
        #     mb.showerror(sub_title, msg)
        # else:
        #     mb.showwarning(sub_title, msg)
